...
INSERT INTO `users` (`id`, `first_name`, `last_name`, `slug`, `email`, `password`, `telephone`, `department_id`, `location_id`, `lead`, `super_user`, `annual_holiday_allowance`, `created_at`, `updated_at`)
VALUES
